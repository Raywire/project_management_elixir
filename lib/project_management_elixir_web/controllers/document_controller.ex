defmodule ProjectManagementElixirWeb.DocumentController do
  use ProjectManagementElixirWeb, :controller

  alias ProjectManagementElixir.Management
  alias ProjectManagementElixir.Management.Document

  action_fallback ProjectManagementElixirWeb.FallbackController
